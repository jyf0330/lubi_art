...
const BATTLE_BACKGROUND_PATHS := [
	"res://Battle/Images/battle_bg/bg1(1).png",
	"res://Battle/Images/battle_bg/bg2.png",
	"res://Battle/Images/battle_bg/bg3.png",
]
const PLAYER_HEALTH_ICON_PATH := "res://Battle/Images/health-icon-green.png"
const ENEMY_HEALTH_ICON_PATH := "res://Battle/Images/health-icon.png"
