...
const PET_PREFAB_PATH := "res://Battle/Prefabs/Pet/BattleUnit.tscn"
const FLOATING_UI_SCENE_PATH := "res://FloatingUI/Scenes/UI.tscn"
const TEST_TEXTURE_PATH := "res://FloatingUI/SpriteImages/Sprite_WhiteFox.png"
