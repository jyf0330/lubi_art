...
const BRONZE_FRAME_TEXTURE_PATH := "res://Features/ArtistFlow/Art/Generated/Output/topper-ready-frames/bronze-frame-top-clear-220.png"
const CREATURE_FRAME_TEXTURE_PATHS := {
	CREATURE_QUALITY_BRONZE: BRONZE_FRAME_TEXTURE_PATH,
	CREATURE_QUALITY_SILVER: "res://Features/ArtistFlow/Art/Generated/Output/topper-ready-frames/silver-frame-top-clear-220.png",
	CREATURE_QUALITY_GOLD: "res://Features/ArtistFlow/Art/Generated/Output/topper-ready-frames/royal-frame-top-clear-220.png",
	CREATURE_QUALITY_DIAMOND: "res://Features/ArtistFlow/Art/Generated/Output/topper-ready-frames/diamond-frame-top-clear-220.png",
}
...
func setup(_view_model: Dictionary) -> void:
	# The current preview data is loaded through GameDataProvider in _ready().
	# Keeping this method stable lets a real adapter replace that source later.
	pass
...
func _go_to_battle() -> void:
	...
	screen_requested.emit(SCREEN_IDS.BATTLE, {})
...
func _get_buttons_from_slots(slots: Array[Control]) -> Array[TextureButton]:
	var buttons: Array[TextureButton] = []
	for slot in slots:
		var button: TextureButton = null
		if slot.has_method("get_button"):
			button = slot.call("get_button") as TextureButton
		if button == null:
			var nested_buttons := _get_texture_buttons(slot)
			if not nested_buttons.is_empty():
				button = nested_buttons[0]
		if button != null:
