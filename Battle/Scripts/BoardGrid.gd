...
const ROUND_BANNER_SCENE := preload("res://Battle/Prefabs/RoundBanner/RoundBanner.tscn")
const MONSTER_BITE_SCENE := preload("res://Battle/Prefabs/Monster_Bite/MonsterBiteEffect.tscn")
const DAMAGE_NUMBER_SCENE := preload("res://Battle/Prefabs/DamageNumber/DamageNumber.tscn")
const ELEMENT_BULLET_SCENE := preload("res://Battle/Prefabs/Element_Bullets/ElementBullet.tscn")

const FIRE_SPRITE := preload("res://Battle/SpriteImages/Sprite_FlameCub.png")
const WATER_SPRITE := preload("res://Battle/SpriteImages/Sprite_WaterWisp.png")
const FIRE_BULLET := preload("res://Battle/Prefabs/Element_Bullets/fire_bullet.png")
const WATER_BULLET := preload("res://Battle/Prefabs/Element_Bullets/water_bullet.png")
const EARTH_BULLET := preload("res://Battle/Prefabs/Element_Bullets/earth_bullet.png")
const WIND_BULLET := preload("res://Battle/Prefabs/Element_Bullets/wind_bullet.png")
const FIRE_BUFF := preload("res://Battle/Prefabs/Element_Buff/elemental-sigil-fire.png")
const WATER_BUFF := preload("res://Battle/Prefabs/Element_Buff/elemental-sigil-water.png")
const EARTH_BUFF := preload("res://Battle/Prefabs/Element_Buff/elemental-sigil-earth.png")
const WIND_BUFF := preload("res://Battle/Prefabs/Element_Buff/elemental-sigil-wind.png")
const PLAYER_HEALTH_ICON := preload("res://Battle/Images/health-icon-green.png")
const ENEMY_HEALTH_ICON := preload("res://Battle/Images/health-icon.png")
const ATTACK_ICON := preload("res://Battle/Images/attack-icon.png")
const PLAYER_DEATH_MARK := preload("res://Battle/Prefabs/Death_Marks/death_mark_player.png")
const ENEMY_DEATH_MARK := preload("res://Battle/Prefabs/Death_Marks/death_mark_enemy.png")
const HOVER_FRAME := preload("res://Battle/SpriteImages/tile_hover_frame_ai_512.png")
const THREE_OPTION_SCENE_PATH := "res://FloatingUI/Scenes/UI.tscn"
const RETURN_FROM_BATTLE_META := &"returning_from_battle"
const MONSTER_BITE_FRAME_01 := preload("res://Battle/Prefabs/Monster_Bite/frames/monster_teeth_bite_01.png")
const ATTACK_ORDER_MARKER_1 := preload("res://Battle/Prefabs/Attack_Order/dice_marker_1.png")
const ATTACK_ORDER_MARKER_2 := preload("res://Battle/Prefabs/Attack_Order/dice_marker_2.png")
const ATTACK_ORDER_MARKER_3 := preload("res://Battle/Prefabs/Attack_Order/dice_marker_3.png")
...
func _return_to_three_option_after_victory() -> void:
	...
	var error := get_tree().change_scene_to_file(THREE_OPTION_SCENE_PATH)
	if error != OK:
		get_tree().remove_meta(RETURN_FROM_BATTLE_META)
		push_warning("Failed to open three-option scene: %s" % THREE_OPTION_SCENE_PATH)
		_battle_return_started = false
		return
